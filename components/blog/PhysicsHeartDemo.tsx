  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '28px 24px 0', position: 'relative', zIndex: 1 }}>
        <div style={{ fontSize: 18, fontWeight: 700, color: '#6b21a8' }}>투두 리스트</div>
          ...
          {todos.map(t => (
            ...
            >
              <div style={{
                ...
                border: `2px solid ${t.done ? '#a855f7' : '#d1d5db'}`,
                background: t.done ? '#a855f7' : 'transparent',
              ...
              <span style={{
                fontSize: 14, color: t.done ? '#9ca3af' : '#111',
